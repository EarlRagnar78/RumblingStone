# Goblin Worg Raider (Fighter 5) [TRANSCRIBED — PCGen, L1 2026-07-08]
**Faction**: red-hand | **Role**: ranged | **Environment**: any | **CR**: 5 | **Source**: PCGen export `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/goblin worg raider cr5.htm` | **Status**: transcribed-pcgen


```statblocco
gs: 5
tipo: Small humanoid (goblinoid), Fighter 5, LE
ca: 19
...
iniziativa: +4
attacchi:
  - Distanza arco corto composito perfetto +12 (1d4/x3), +13 (1d4+1) entro 9 m (Tiro Ravvicinato/Preciso)
voci:
...
Notes: cavalca il worg (vedi `worg-cavalcatura-cr2.md`); coppia raider+worg ≈ EL 6.
