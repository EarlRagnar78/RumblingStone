...
**10 aperte** · 24 chiuse — generato da `scripts/decisioni_dm.py --emit`, non si scrive a mano.
...
| **D5** | `CONFORMITA-STATBLOCCHI` | `ghost-lion-spettrale-cr8` | **Come si legge il template?** Non morto con Cos 20 e `8d12+40`: nel 3.5 un non morto non ha Costituzione, e il bonus ai pf e' della regola PF1e (Carisma). L'attacco +15 non torna con BAB da non morto (+4) ne' da animale (+6) 🔎 **2026-09-23**: il DM aveva scelto la lettura «fantasma PF1e» (8d12+16), ma la **fonte d'arco** (`Arco-Post-Hammerfist-P3-Ghostlord-LICH-ALLEANZA-STATBLOCCHI` §2) ha già numeri del DM coerenti col 3.5: **9d12 (~58 pf)**, CA 20 (Des +4, deflessione +7), BAB +4, **morso incorporeo +10 (2d6 freddo + energia negativa)**, TS +3/+7/+7. La scheda del Bestiario se n'è allontanata (8d12+40, Cos 20, spada corta). La domanda diventa: **si trascrive la fonte?** |
| **D7** | `CONFORMITA-STATBLOCCHI` | `druid-bear-ally-cr12` | **I 120 pf sono in forma selvatica?** Con `12d8` e Cos 13 il massimo possibile e' 108. In forma d'orso (Cos 19) la fascia arriva a 144 e 120 ci sta: se e' cosi', la scheda lo deve dire ✅ **Il DM, 2026-09-23: sì, 120 pf in forma d'orso, e due gruppi di statistiche distinti, forma d'orso e forma umana.** 🔎 **Ma la fonte d'arco** (`…STATBLOCCHI-EPICI` §6) dice **Druido 10 / Barbaro 2**, `12d8+48` (~102 pf), in forma d'orso **For 27, CA 20**, mentre la scheda dice Druido 12 e CA 19. Prima di scrivere i due gruppi: **quale composizione?** |
