...
| [PIANO-REINTEGRAZIONE-PNG-AP-RHOD](PIANO-REINTEGRAZIONE-PNG-AP-RHOD.md) | Contenuto: reintegrazione PNG dell'AP originale (Guado di Drellin, Rethmar 2° anello, Witchwood/Tiri Kitor, Wyrmlord) + proposta PNG caotico Lirien | 🟡 R1+R5 fatti e **canonizzati** (2026-07-20), R2-R4 preparazione | ~55% | R2 (Rethmar 2° anello) · R3 (Witchwood/Tiri Kitor) · R4 (Wyrmlord, decisione DM) | R4: decisione DM |
