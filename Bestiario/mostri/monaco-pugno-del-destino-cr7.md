# Monaco «Pugno del Destino» (Monk 7) [TRANSCRIBED — PCGen, L1 2026-07-08]
**Faction**: red-hand | **Role**: melee-heavy | **Environment**: any | **CR**: 7 | **Source**: PCGen export `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/monaco pugno del destino cr7.htm` | **Status**: transcribed-pcgen


```statblocco
gs: 7
tipo: Medium humanoid (goblinoid), Monk 7 (ordine del Pugno del Destino), LE
ca: 19
...
iniziativa: +2
attacchi:
  - Mischia catena chiodata perfetta a due mani +10/+10 (2d4+4); raffica di colpi +9/+9/+9 (1d8+3, ki = magico)
voci:
...
Notes: campioni monastici hobgoblin del culto; ottimi inseguitori (vel 24 m).
