...
| [PIANO-DM-TOOLKIT](PIANO-DM-TOOLKIT-HYPE-E-ARCHIVIO-PIANI.md) | Infrastruttura: CLI dm.py · hype Homebrewery · questo archivio | 🟡 in esecuzione | ~85% | K-B3 (a lotti) | K-B0: verifica DM template pack (default: snippet V3 nativi) · K-B3: ①-② validate al tavolo |
