...
## PARTE 4 - Piano Elementale della Terra (VERSIONE FINALE RICALIBRATA)
...
1. **Ingresso e Meccanica Gravitazionale Aggiornata**
2. **Mappa Tattica A: La Foresta di Cristallo**
3. **Incontro 1: L'Agguato delle Fauci di Diamante (CR 14)**
4. **Skill Challenge: Il Canto dei Cristalli Viventi (CR 12)**
5. **Mappa Tattica B: Il Tempio Mithral (Anti-Gravità)**
6. **Evento Scriptato: Risveglio dei Bracieri (Addendum)**
7. **Boss Fight: Terros, l'Incudine del Mondo (CR 16)**
8. **Il Rituale dello Smeraldo: "Anvil of the World"**
9. **Statistiche Complete Mostri**

---

## 1. INGRESSO: LA GRAVITÀ SCHIACCIANTE

> *Non c'è cielo. Non c'è orizzonte. Solo roccia sopra, roccia sotto, roccia ovunque. E una pressione schiacciante, come se foste sepolti vivi.*

**Meccanica Ambientale: Gravità x2 "Iraconda"**
Anche con la *Benedizione Forza Montagna* di Moradin, il piano resiste alla vostra presenza.
...
## 2. INCONTRO 1: L'AGGUATO DELLE FAUCI DI DIAMANTE (CR 14)

**Luogo:** Foresta di Cristalli Giganti. Colonne prismatiche alte 50m bloccano la vista.
**Nemici:**

* **1x Xorn Anziano "Fauci di Diamante"** (Elite, mangia-magia).
* **2x Xorn Anziani** (Standard).

### **Mappa Tattica A: Foresta di Cristallo**
...
## 3. SKILL CHALLENGE: IL CANTO DEI CRISTALLI (CR 12)

(Vedi sezione precedente per meccaniche base. Qui dettaglio le conseguenze).

* **Fallimento Critico (3 fallimenti):** I Cristalli Viventi "urlano".
  * Danno: 10d6 Sonico a tutti (No TS).
  * Allarme: Terros (il Boss finale) viene svegliato e PREPARATO (non potrà essere sorpreso).
* **Successo Critico:** Madre Cristallo dona un frammento **"Diapason Armonico"**.
  * Uso: 1 volta sola, stunna Terros per 1 round (No TS).
...
### **Mappa Tattica C: Camera Sferica (Sezione Laterale)**

```
          /‾‾‾‾‾‾‾‾‾‾‾‾‾\
        /      (0G)       \
       |   . . . . . . .   |
       |   .           .   |      A = Altare (Unico punto con Gravità)
       |   .    T E    .   |      E = Terros (Il Boss)
      [P]  .   ALTARE  .   |      T = Thorik (in mischia)
       |   .           .   |      P = Portale Ingresso
       |   . . . . . . .   |
        \                 /
          \_____________/
...
## 6. IL RITUALE DELLO SMERALDO: "ANVIL OF THE WORLD"

**Condizione:** Terros sconfitto, si sbriciola rivelando lo **Smeraldo della Forza**.
Il rituale inizia. Deve seguire le regole della Corona (`00_corona_di_adamantio...md` - Rituale 3).

**Fasi del Rituale (Skill Challenge Ad Alta Tensione):**
...
Moradin parla, voce che fa tremare le ossa:
...
* *Loot Disponibile:* Geode Titanico (5k) + Mithral Golem (5k) + Diamanti Xorn (2k) = 12k. Non basta. Devono sacrificare praticamente tutto il proprio equipaggiamento magico personale.

**Opzione B (Sacrificio Personale - Il Vero Pathos):** Thorik accetta il "Peso" nel proprio corpo.
> *Sotto la gravità demoniaca, Thorik sente le ossa scricchiolare. Il dolore è accecante. Poi... una sensazione fredda e rassicurante alle spalle. Una luce verde tenue (se il corpo è vicino o anche solo a distanza dimensionale). Lo spirito di Hella si stringe a lui telepaticamente: "Non sei solo a portare questo peso, Thorik. Mai più solo." La pressione si stabilizza grazie a lei.*
...
**Effetto Epico:** Un'onda d'urto smeraldo vi investe. Per un'ora, la vostra carne diventa "pietra vivente" (DR 10/Adamantio gratis). E Thorik, toccando la gemma, sente che l'ancoraggio dello spirito di Hella si è cristallizzato: ora è **impossibile** perderla. La resurrezione è solo a un passo.

---

## 7. STATISTICHE COMPLETE DEI MOSTRI

### **XORN ANZIANO "FAUCI DI DIAMANTE" (CR 11)**

*Advanced 15HD Elder Xorn*

* **HP:** 180
* **CA:** 28 (+18 naturale)
* **DR:** 10/Adamantio
* **Attacchi:** 1 Morso +22 (4d8+10, ignora durezza <20), 3 Artigli +20 (1d8+5).
...
* Mostri (Xorn + Terros): 24.000 XP tot.
* Skill Challenge + Rituale: 4.000 XP tot.
* Totale: 28.000 / 4 = **7.000 XP a testa**. (Level Up Molto Probabile).

**Loot Finale:**

* Smeraldo della Forza (Artefatto).
* Residuo del Boss: **Cuore di Terros** (Oggetto meraviglioso, può essere usato per craftare un *Amuleto dell'Armatura Naturale +5* o usare come componente rituale da 20.000 mo).

**Cliffhanger:**
Lo Smeraldo è attivo. La Corona ora ha 2 Gemme su 3.
Affresco A6 (Tempo) si accende. È ora di tornare indietro e salvare Moradin.
