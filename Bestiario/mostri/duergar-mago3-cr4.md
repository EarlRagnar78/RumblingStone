# Duergar Mago (Wizard 3, necromante) — «Losse hinge» [TRANSCRIBED — PCGen, L1 2026-07-08]
**Faction**: duergar-abbathor | **Role**: caster-arcane | **Environment**: underdark | **CR**: 4 | **Source**: PCGen export `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/Duergar_figther_ponte/Duergar_mago_3liv_4cr.html` | **Status**: transcribed-pcgen


```statblocco
gs: 4
tipo: Medium humanoid (dwarf, duergar), Wizard 3 (necromanzia; abiurazione proibita), LE
ca: 13
...
iniziativa: +2
attacchi:
  - Distanza balestra leggera perfetta +3 (1d8)
voci:
...
Notes: mago da supporto del ponte; coppia con il chierico Justin.
