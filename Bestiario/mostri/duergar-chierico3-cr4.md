# Duergar Chierico di Abbathor (Cleric 3) — «Brother Justin» [TRANSCRIBED — PCGen, L1 2026-07-08]
**Faction**: duergar-abbathor | **Role**: caster-divine | **Environment**: underdark | **CR**: 4 | **Source**: PCGen export `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/Duergar_figther_ponte/Duergar_Chierico_3liv_4cr.html` | **Status**: transcribed-pcgen


```statblocco
gs: 4
tipo: Medium humanoid (dwarf, duergar), Cleric 3 (Abbathor; domini Inganno/Male), LE
ca: 20
ca-dettaglio: touch 10, flat-footed 20 (piastre complete)
pf: 24
pf-dado: 1d8+2
...
iniziativa: +3
attacchi:
  - Mischia flagello perfetto +6 (1d8+2)
voci:
...
Notes: sacerdote minore del culto di Abbathor al ponte.
