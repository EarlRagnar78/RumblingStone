...
- ⬜ _(Lotto A: estrarre ADR-0007 in `plans/adr/` + `campaign_branch.py` guardia anti-main + scheletro `dm.py session` — le domande §8 sono state risposte dal DM il 2026-07-20)_
- ⬜ _(poi B→F in ordine di dipendenza; D4/E1 riusano `hype_homebrew.py`/`dm_dossier.py`/cronologia come da §3-bis)_
