...
| [PIANO-IMPORT-ULTRACLEAR](PIANO-IMPORT-ULTRACLEAR-ASCII-TO-JSON.md) | Infrastruttura: `import_ultraclear.py` — ASCII ultra-clear → **bozza JSON contratto + report conflitti** (migrazione semi-automatica delle mappe esistenti) | 🔵 **pianificato** (2026-07-23) | 0% | F1-F7 (parser griglia/tabelle, diagnostica 4 difetti-tipo, emissione bozza, CLI+round-trip, golden case Hammerfist, doc/CI) | — |
...
- ⬜ _(F1-F7 da avviare: parser griglia+tabelle, diagnostica 4 difetti-tipo, bozza JSON+report, CLI, golden case Hammerfist L2, doc/CI — nessun lotto ancora eseguito)_
