# Ogre Skullcrusher [TRANSCRIBED — web FR, L1 2026-07-08]
**Faction**: red-hand | **Role**: melee-heavy | **Environment**: mountain | **CR**: 5 | **Source**: Races of Faerûn (via realmshelps, `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/Ogre, Skullcrusher cr5.html`) | **Status**: transcribed


```statblocco
gs: 5
tipo: Large giant, NE, 8d8+24
ca: 20
ca-dettaglio: (-1 taglia, +2 naturale, +7 mezza piastra chiodata, +2 scudo pesante chiodato), touch 9, flat-footed 20
pf: 60
pf-dado: 8d8+24
...
Notes: la stirpe Skullcrusher — la linea di **Fauci di Palude**/eredità Skullcrusher (ARC08-10 §4.1). Unità d'assalto pesante.
