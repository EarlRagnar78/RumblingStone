...
- Foresta Sacra (60m x 60m griglia 40x40, quadrati 1.5m), con il cerchio druidico al centro.  
- Sentieri di accesso, zone di fumo/incendio in espansione, presenze di spiriti guardiani e nemici piromani.  

***

## Parte 2: Prima Fase del Ritual – Purificazione
...
- 2 piromani drow inviati per disturbare il rituale (combattimento tattico).  
- Spirito Guardiano della Foresta (provocazione verbale/combattimento).  

***

## Parte 3: Seconda Fase – Evocazione Elementale
...
- 2 piromani drow con incantesimi di fuoco e armatura leggera (livello appropriato per 3 PG di livello 13)  
...
- Foresta Sacra Antica, zona circolare 60m di diametro (circa 40x40 griglia 1.5m quadrati).  
- Elementi mappa:  
  - Cerchio druidico centrale con pietre rune incise (raggio 9m)  
  - Sentieri boscosi ricchi di folta vegetazione (richiede prove sopravvivenza)  
  - Aree in fiamme parziali in espansione con possibilità di estinzione o propagazione (danno ambiente)  
  - Due ingressi principali sorvegliati  

***

### Incontri e Sfide  

**1. Esplorazione e Prove Ambientali**  

- Prove Salute (Costituzione) per evadere fumi tossici (DC 15).  
- Prove Sopravvivenza (DC 18) per orientarsi e non perdersi.  
- Prove Natura o Religione (DC 20) per riconoscere le rune e capire i rituali.
...
- **Fase 2: Invocazione Elementale**  
  - Intonazione progressiva del "Canto della Natura", richieste prove multiple di Intuizione o Religione DC 20.  
  - Danni ambientali aumentano con fallimenti.  
