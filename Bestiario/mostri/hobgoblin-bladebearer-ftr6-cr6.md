# Hobgoblin Bladebearer (Fighter 6) [TRANSCRIBED — PCGen, L1 2026-07-08]
**Faction**: red-hand | **Role**: melee-heavy | **Environment**: any | **CR**: 6 | **Source**: PCGen export `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/hobgoblin bladebearer 6 liv.htm` (+ variante `...longsword.htm`) | **Status**: transcribed-pcgen


```statblocco
gs: 6
tipo: Medium humanoid (goblinoid), Fighter 6, LE
ca: 19
...
**Build B — due spade lunghe**: AC 20, touch 15, ff 16. Spada lunga +1 +11/+6 (1d8+6/19-20) e spada lunga perfetta +11/+6 (1d8+3/19-20); Improved/Oversized Two-Weapon Fighting, Arma Specializzata.
Notes: l'élite «portalame» a due armi della Mano Rossa (versione IT CR 7 = file separato `hobgoblin-portalame-ftr7-cr7.md`).
