# Tarsilia — la Ruota (pista del Drappo)
...
@mark 4 ; D29 ; Berenice — carro degli alfieri (barda 3)
@mark 5 ; D22 ; Tesio e Melchio — palco (mago 3 · chierico 3)
...
|---|---|---|
| 🎯 CURVA NORD | AG10 | CD 17. Fallire di 5+ = caduta (2d6, prono, poi 1d6/tratto sotto gli zoccoli). Al terzo giro il transennato cede sulla gente dell'ospizio |
| 🎯 CURVA SUD | AG37 | CD 15. Fallire di 5+ = il cavallo rifiuta, −1 Lunghezza. Il palco NON vede: è qui che si scudiscia |
| 🔔 LE FUNI — lo Stacco | L23 | Sette cavalli fra le funi, l'ottavo di rincorsa. Iniziativa contrapposta + finte: Lotta, Percezione vs Raggirare, Intimidire CD 15 |
