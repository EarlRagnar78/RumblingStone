...
| [PIANO-REINTEGRAZIONE-PNG-AP-RHOD](PIANO-REINTEGRAZIONE-PNG-AP-RHOD.md) | Contenuto: reintegrazione PNG dell'AP originale (Guado di Drellin, Rethmar 2° anello, Witchwood/Tiri Kitor, Wyrmlord) + proposta PNG caotico Lirien | 🟡 R1+R5+R7 canonizzati; R2+R3 **preparati** (2026-07-20); resta R4 | ~85% | R4 (Wyrmlord Ulwai + decisione DM Hravek Kharn vs Karruk) | R4: decisione DM |
