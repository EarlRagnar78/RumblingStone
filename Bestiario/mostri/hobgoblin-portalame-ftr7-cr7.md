# Hobgoblin Portalame (Fighter 7) [TRANSCRIBED — PCGen, L1 2026-07-08]
**Faction**: red-hand | **Role**: melee-heavy | **Environment**: any | **CR**: 7 | **Source**: PCGen export `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/regolari/hobgoblin-portalame cr7.htm` | **Status**: transcribed-pcgen


```statblocco
gs: 7
tipo: Medium humanoid (goblinoid), Fighter 7, LE
ca: 19
...
iniziativa: +3
attacchi:
  - Mischia spada corta +1 +12/+7 (1d6+6/19-20) e spada corta +1 +12 (1d6+4/19-20) — Two-Weapon Pounce alla carica
voci:
...
Notes: evoluzione CR 7 del bladebearer; guardia scelta dei Wyrmlord.
