...
| [PIANO-DRAPPO-DI-TARSILIA](PIANO-DRAPPO-DI-TARSILIA-STANDALONE-PF1E.md) | Contenuto: **modulo autonomo** — il sistema del Palio riambientato a **Golarion** e convertito a **Pathfinder 1e**, sei schede pregenerate di 3°, tre sessioni da 3-4 ore, città originale (Tarsilia, Regno dei Fiumi). Zero dipendenze da Forgotten Realms / Red Hand of Doom: è la strada indicata da [ADR-0005](adr/ADR-0005-confini-ip-uso-non-commerciale.md) e messa in coda da [ADR-0016](adr/ADR-0016-lingua-sorgente-e-edizioni.md) §2 | 🟡 Lotti 1-2-5 chiusi (impianto · profondità AP · **apparato d'uso** · 3 booklet con PDF · ADR-0017/0018 · gate CI) | ~90% | L3 collaudo al tavolo (durate reali, ritratti raster, alfa→beta) · L4 edizione pubblicabile (rinomina contrade **sospesa per scelta DM**, 4 figure di stemma, audit IP) | L3: una sessione vera · L4: decisione DM su ADR-0005 |
