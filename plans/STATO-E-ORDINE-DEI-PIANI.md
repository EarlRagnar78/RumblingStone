...
**9 aperte** · 26 chiuse — generato da `scripts/decisioni_dm.py --emit`, non si scrive a mano.
...
| ~~D5~~ | `CONFORMITA-STATBLOCCHI` | `ghost-lion-spettrale-cr8` | ✅ **decisa dal DM il 2026-09-23: si trascrive la fonte d'arco** (`…Ghostlord-LICH-ALLEANZA-STATBLOCCHI` §2): 9d12 (pf 58), CA 20, BAB +4, morso incorporeo +10, TS +3/+7/+7. pf, BAB e i tre TS tornano col SRD. Restano due numeri della fonte che non tornano con la sua Des: sono **D12** |
