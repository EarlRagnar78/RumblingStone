...
- 🟡 **F4 · #99**: 4a, 4b, 4c, 4d (4d-1 … 4d-8) e **4e** (una sola via di
  ...
  rami. Al DM restano **D22** (quattro di quei file) e **D23** (la protezione
  del ramo `main`).
...
**16 aperte** · 34 chiuse — generato da `scripts/decisioni_dm.py --emit`, non si scrive a mano.
