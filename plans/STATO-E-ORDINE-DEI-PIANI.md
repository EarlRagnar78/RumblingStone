...
- 🟡 **F4 · #99**: 4a, 4b, 4c, 4d (4d-1 … 4d-8) e **4e** (una sola via di
  ...
  del DM: 4i-1 ✅, il gate vede i percorsi fra backtick in tutti i sorgenti;
  4i-2 dà un posto ai file rimasti nei rami, e il loro destino è **D22**.
...
**11 aperte** · 32 chiuse — generato da `scripts/decisioni_dm.py --emit`, non si scrive a mano.
