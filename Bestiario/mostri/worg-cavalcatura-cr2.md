# Worg (cavalcatura avanzata, 6 HD) [TRANSCRIBED — PCGen, L1 2026-07-08]
**Faction**: red-hand | **Role**: mount | **Environment**: any | **CR**: 2 | **Source**: PCGen export `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/Worg.htm` | **Status**: transcribed-pcgen


```statblocco
gs: 2
tipo: Medium magical beast, NE, 6 HD (avanzato dal worg MM 4 HD)
ca: 14
...
iniziativa: +2
attacchi:
  - Mischia morso +9 (1d8+4) + Sgambettare (trip)
voci:
...
Notes: la cavalcatura dei goblin raider; l'avanzamento a 6 HD mantiene CR 2 da export (MM worg base = 4 HD).
