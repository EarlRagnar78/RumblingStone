# Hell Hound mezzo-immondo (dragonblood) [TRANSCRIBED — PCGen, L1 2026-07-08]
**Faction**: red-hand | **Role**: melee-heavy | **Environment**: any | **CR**: 4 | **Source**: PCGen export `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/Hell Hound 4cr .htm` (+ variante `Hell Hound_draconico.pcg`) | **Status**: transcribed-pcgen


```statblocco
gs: 4
tipo: Medium outsider (evil, extraplanar, fire, lawful, dragonblood), 4 HD, LE
ca: 17
...
iniziativa: +5
attacchi:
  - Mischia morso +6 (1d8+3 + Morso Infuocato)
voci:
...
**Variante draconica** (`Hell Hound_draconico.pcg` + `regolari/Hell Hound - Draconic.pcg`): template Draconic Creature sul medesimo outsider 4 HD — +2 AC naturale e immunità a sonno/paralisi `[INFERRED — derivati dal template, .pcg senza export]`.
Notes: i segugi della Mano Rossa; usati in coppia coi Doom Hand.
