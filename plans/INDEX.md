...
| [PIANO-RENDER-MAPPE-FEDELTÀ-DETTAGLI](PIANO-RENDER-MAPPE-FEDELTA-DETTAGLI.md) | Infrastruttura: renderer mappe a **fedeltà piena** (ASCII ultra-clear → SVG senza perdere posizioni/annotazioni/token); ASCII resta lo standard finché il renderer non è fedele | 🔵 aperto, non iniziato | 0% | F1-F6 (contratto ASCII v2, parser fedele, callout semantici, griglie esagonali, passata ARC-07, CI) | task futuro su richiesta DM (ora si resta ASCII) |
