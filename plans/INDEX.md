...
| [PIANO-DRAPPO-DI-TARSILIA](PIANO-DRAPPO-DI-TARSILIA-STANDALONE-PF1E.md) | Contenuto: **modulo autonomo** — il sistema del Palio riambientato a **Golarion** e convertito a **Pathfinder 1e**, sei schede pregenerate di 3°, tre sessioni da 3-4 ore, città originale (Tarsilia, Regno dei Fiumi). Zero dipendenze da Forgotten Realms / Red Hand of Doom: è la strada indicata da [ADR-0005](adr/ADR-0005-confini-ip-uso-non-commerciale.md) e messa in coda da [ADR-0016](adr/ADR-0016-lingua-sorgente-e-edizioni.md) §2 | 🟡 Lotto 1 chiuso (impianto giocabile completo) | ~60% | L2 collaudo al tavolo (durate reali, ritratti da ComfyUI) · L3 edizione pubblicabile (audit IP dedicato, 4 figure di stemma da sostituire, Homebrewery) | L2: una sessione vera · L3: decisione DM su ADR-0005 |
...
- ⬜ _(L2 — collaudo al tavolo: durate reali per giornata, punti morti, prove mai usate. **Gated**: serve una sessione giocata)_
