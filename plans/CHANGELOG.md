...
| 2026-07-12 | DM-TOOLKIT | Lotto K-B5 (container) | questo commit | ✅ Docker chiavi-in-mano: compose ufficiale naturalcrit (mongodb+app), setup-docker.sh/stop-docker.sh, `dm.py hype docker\|docker-stop`, guida "da zero al container" |
