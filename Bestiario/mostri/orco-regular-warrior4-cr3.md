# Orco Regular (Warrior 4) [INFERRED — needs DM confirmation]
**Faction**: red-hand | **Role**: fodder | **Environment**: any | **CR**: 3 | **Source**: PCGen save `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/orc_regular.pcg` (solo .pcg, nessun export) | **Status**: inferred


```statblocco
gs: 3
tipo: Medium humanoid (orc), Warrior 4, LE
ca: 16
ca-dettaglio: (cotta di maglia + Des)
pf: 30
ts: Temp +6, Rifl +2, Vol +1
attributi: For 14 Des 13 Cos 14 Int 12 Sag 11 Car 10
