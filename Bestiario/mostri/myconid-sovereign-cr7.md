# Myconid Sovereign (sovrano miconide) [TRANSCRIBED — homebrew 3.5, L1 2026-07-08]
**Faction**: aberration | **Role**: caster-boss | **Environment**: underdark | **CR**: 7 | **Source**: encounter homebrew 3.5 `Bestiario/pregen-pcgen/00_scaladossa-abbattor-funghi/Fight_fungi_colony-formatted.txt` (NON la pagina Kassoon, che è 5e) | **Status**: transcribed


```statblocco
gs: 7
tipo: Large plant, 14d8+56
ca: 20
ca-dettaglio: (-1 taglia, +11 naturale), touch 9, flat-footed 20
pf: 119
pf-dado: 14d8+56
...
Notes: il boss della colonia di funghi (scala di ossa/abattor). ⚠️ La sorgente d'incontro elenca «CR 12» in coda (calcolo XP di quel setup), ma lo statblock è un Large plant 14 HD ≈ **CR 7**: qui vale 7 `[INFERRED — needs DM confirmation]`. Le guardie sono file separati.
