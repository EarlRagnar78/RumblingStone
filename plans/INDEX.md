...
| [PIANO-DM-TOOLKIT](PIANO-DM-TOOLKIT-HYPE-E-ARCHIVIO-PIANI.md) | Infrastruttura: CLI dm.py · hype Homebrewery · questo archivio | 🟡 in esecuzione | ~35% | K-C1 · K-B1 · K-B2 · K-C2 · K-C3 · K-B3 (a lotti) | K-B0: verifica DM template pack (default: snippet V3 nativi) · K-B3: ①-② validate al tavolo |
...
### PIANO-DM-TOOLKIT
- ⬜ _(K-B0: verdetto DM sul template pack dungeons-and-pi)_
- ⬜ _(K-B3: dopo validazione al tavolo delle ondate ①-②)_
