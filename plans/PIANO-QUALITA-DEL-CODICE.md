...
### §8.2 · La misura di partenza (presa il 2026-09-23 su `45306c8`, rimisurata dopo le decisioni D1-D7 della conformità)

| Cosa | Oggi | Come si rimisura |
|---|---:|---|
| Righe dei quattro script | **3.486** | `wc -l scripts/{derive_statblocks,genera_attributi,genera_creatura,conformita_statblocchi}.py` |
...
| Test | **1163** verdi, 21 saltati | `python3 -m pytest -q scripts/tests/` |
| Taratura dello strato scelto | **1,50** in campione · **1,51** fuori | `python3 scripts/genera_attributi.py --taratura` |
| Conformità | **101** tornano · 5 come la fonte · 1 decisione (D12) · 0 da correggere · 0 scarti del generatore | `python3 scripts/conformita_statblocchi.py --riepilogo` |
...
```bash
python3 -m pytest -q scripts/tests/                     # ≥ 1163 verdi, piu' i test nuovi
...
python3 scripts/conformita_statblocchi.py --riepilogo   # 101 · 5 · 1 · 0 · 0
...
wc -l scripts/{derive_statblocks,genera_attributi,genera_creatura,conformita_statblocchi}.py   # 3486
grep -n "import conformita_statblocchi" scripts/genera_attributi.py                            # 1 riga
python3 -m pytest -q scripts/tests/ | tail -1                                                  # 1163 passed
python3 scripts/conformita_statblocchi.py --riepilogo                                          # 101 · 5 · 1 · 0 · 0
