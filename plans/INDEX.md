...
| [PIANO-REINTEGRAZIONE-PNG-AP-RHOD](PIANO-REINTEGRAZIONE-PNG-AP-RHOD.md) | Contenuto: reintegrazione PNG dell'AP originale (Guado di Drellin, Rethmar 2° anello, Witchwood/Tiri Kitor, Wyrmlord) + proposta PNG caotico Lirien | 🟡 R1+R5 fatti, R2-R4 preparazione | ~40% | R2 (Rethmar 2° anello) · R3 (Witchwood/Tiri Kitor) · R4 (Wyrmlord, decisione DM) · R6 (canonizzazione DM di R1+R5) | R4/R6: decisione DM |
...
- ⬜ _(R6 — canonizzazione DM di R1 [Profughi del Guado] e R5 [Lirien]: sciogliere i flag [INFERRED] e applicare le righe proposte per state.md §3/§7)_
