...
| REVISIONE TRASVERSALE | `PIANO-REVISIONE-TRASVERSALE-...md` | 🟡 gated dal tavolo | ~90% | T6c (gate: conferma DM) · T8 (gate: quest ARC-09 giocata) · T9 chiusura post-P3B · SVG dei 16 narrativi (opzionale) |
| DM-TOOLKIT (questo) | root → `plans/` | ⬜ in approvazione | 0% | tutto (§2-§4) |
...
**Completamento piano: 0%** (documento in approvazione DM)

- [ ] **K-A** (archivio piani): [ ] K-A1 · [ ] K-A2 · [ ] K-A3 · [ ] K-A4 — 0/4
