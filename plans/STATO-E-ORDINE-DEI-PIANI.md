...
- 🟡 **F4 · #99**: 4a, 4b, 4c, 4d (4d-1 … 4d-8) e **4e** (una sola via di
  ...
  fatti, 4f-4 e 4f-5 aspettano **D21**), **4g** (schede PG a dati), **4h**
...
**12 aperte** · 32 chiuse — generato da `scripts/decisioni_dm.py --emit`, non si scrive a mano.
