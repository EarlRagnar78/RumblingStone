# Avarthel, druido mezzelfo [TRANSCRIBED — PCGen, L1 2026-07-08]
**Faction**: cerchio-druid | **Role**: caster-divine | **Environment**: forest | **CR**: 9 | **Source**: PCGen export `Bestiario/pregen-pcgen/png_La_mano_rossa_del_destino/druido Avarthel cr9.htm` | **Status**: transcribed-pcgen


```statblocco
gs: 9
tipo: Medium humanoid (elf/human), Druid 9, NG
ca: 19
...
iniziativa: +2
attacchi:
  - Mischia scimitarra +1 +8/+3 (1d6+2/18-20); Distanza fionda perfetta +9/+4
voci:
...
Notes: druido del Cerchio (area Witchwood/Hellas); alleato → `png/`.
