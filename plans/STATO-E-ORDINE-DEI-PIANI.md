...
**15 aperte** · 35 chiuse — generato da `scripts/decisioni_dm.py --emit`, non si scrive a mano.
...
| **D24** | `RIPRESA-PR` | F4 · 4i | **Una conferma sola, ora: dove fugge il Collezionista.** Cercato il 2026-09-24 in ogni commit, file di ogni ramo, PR chiuse (anche la #131, che portò il canone della discesa su `main`) e commenti, e nei due fogli XP del DM letti direttamente. ✅ **Il GS di Maur aveva la tua risposta**: il foglio XP dice *«il capo dei minotauri maur cr 11»*, e il «~10» della cronaca era il GS del Collezionista della stessa riga (*«un rakasa (il collezionista fuggito cr 10)»*). Corretto in cronaca e nella skill di lore. 🟡 **Per la destinazione, nessuna conferma esplicita in nessun posto.** La tua risposta di luglio era: invisibile, il monaco unico testimone, un monile di ossidiana o un altro oggetto che lo porta «in un'altra località di Faerûn o in un altro piano, temporaneamente», e *«scegli la soluzione più coerente»*. Quindi la scelta l'avevi **delegata**. Nel canone c'è già un pezzo della risposta: dal 23 luglio la rete di **Varis ↔ Collezionista** è collegata e «viaggia tra i piani e le epoche», con un mercato planare che i PG incrociano sul Piano della Terra. La proposta resta il **Piano del Fuoco**, dove la sua gilda vendette Therysol ai salamandri. ⚠️ Il dossier del Bestiario fa di Varis l'identità di copertura del Collezionista, mentre ARC07-DEF-1 li tratta come due reti collegate: non tocca la domanda, ma va saputo. **Domanda**: la delega di luglio vale come scelta (Piano del Fuoco diventa canone), o preferisci deciderlo tu? |
